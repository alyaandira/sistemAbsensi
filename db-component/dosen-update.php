...
$SQL_query = "UPDATE `$dosen_table` SET `$dosen_nip`='$input_dosen_nip',`$dosen_nama`='$input_dosen_nama',`$dosen_email`='$input_dosen_email',`$dosen_fakultas`='$input_dosen_fakultas',`$dosen_jurusan`='$input_dosen_jurusan' WHERE `$dosen_nip`='$input_dosen_nip'";
