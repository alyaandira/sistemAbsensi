 ...
 <aside class="left-sidebar" data-sidebarbg="skin6">
     ...
     <div class="scroll-sidebar" data-sidebarbg="skin6">
         ...
         <nav class="sidebar-nav">
             <ul id="sidebarnav">
                 <!-- <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="mhs-absensi.php" aria-expanded="false"><i data-feather="home" class="feather-icon"></i><span class="hide-menu">Beranda</span></a></li> -->
                 <li class="sidebar-item"> <a class="sidebar-link" href="mhs-daftarMatkul.php" aria-expanded="false"><i data-feather="tag" class="feather-icon"></i><span class="hide-menu">Daftar Mata Kuliah</span></a></li>
